...
# эта фукнция скопирована из файла distance один в один, если импортом что-то не так просто расскоментируйте
# эту функцию и удалите импорт файла distance
...
def main():
    print("Пример адреса дома: Россия, Москва, Никольская улица")
    print("Пример адреса школы: Россия, Москва, улица Земляной Вал, 33")
